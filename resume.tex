...
\begin{itemize}
  ...
  % \item streamlined the project creation process, by completing multiple growth courses, improving team coordination and reducing project duration by 50\%
...
% languages: python (expert), c\# (proficient), java (~15 projects), react
% technologies
